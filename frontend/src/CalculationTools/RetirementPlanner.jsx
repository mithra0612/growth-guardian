    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-blue-100 to-blue-200 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-extrabold text-blue-900 mb-3 tracking-tight">Retirement Planning Calculator</h1>
          <p className="text-lg text-blue-700 max-w-2xl mx-auto">Plan your financial future with confidence using our India-focused calculator</p>
        </div>
            ...
            <div className="mt-8">
              <button
                ...
                className={`w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold text-lg transition-all duration-200 flex items-center justify-center
                  ${isCalculating ? 'opacity-75 cursor-not-allowed' : 'hover:bg-blue-700 hover:shadow-lg'}`}
              >
                {isCalculating ? (
                  <>
        ...
        <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
          <div className="p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Retirement Plan Results</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-blue-700">Years until retirement</p>
                <p className="text-2xl font-bold text-blue-900">{results.yearsToRetirement} years</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-blue-700">Projected savings at retirement</p>
                <p className="text-2xl font-bold text-blue-900">₹{results.projectedSavings.toLocaleString()}</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-blue-700">Monthly income from savings</p>
                <p className="text-2xl font-bold text-blue-900">₹{results.monthlyIncomeFromSavings.toLocaleString()}</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-blue-700">Savings gap</p>
                <p className="text-2xl font-bold text-blue-900">₹{results.savingsGap.toLocaleString()}</p>
              </div>
            </div>
            ...
            {results.savingsGap > 0 && (
              <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                <p className="text-yellow-800 font-medium">
                  To meet your desired income of ₹{desiredMonthlyIncome.toLocaleString()}, you'll need an additional monthly contribution of:
                </p>
            ...
            <div className="mt-6 text-sm text-gray-600">
              ...
              <p>*Actual results may vary due to market conditions and other factors.</p>
            </div>
          </div>
        </Modal>
      </div>
